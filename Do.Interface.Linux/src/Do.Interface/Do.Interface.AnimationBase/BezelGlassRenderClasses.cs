...
namespace Do.Interface.AnimationBase
{
	...
	{
		int Height { get; }
		void RenderElement (Context cr, Gdk.Point renderAnchor, int width, Element item, bool drawArrow);
	}
	...
	public class BezelFullResultItemRenderer : IBezelResultItemRenderer
	{
		...
		public void RenderElement (Context cr, Gdk.Point renderAnchor, int width, Element item, bool drawArrow)
		{
