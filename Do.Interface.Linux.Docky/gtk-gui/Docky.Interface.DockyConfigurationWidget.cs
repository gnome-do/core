...
namespace Docky.Interface {
    ...
    public partial class DockyConfigurationWidget {
        ...
        protected virtual void Build() {
            ...
            Gtk.Box.BoxChild w19 = ((Gtk.Box.BoxChild)(this.hbox2[this.hbox3]));
            w19.Position = 1;
            // Container child hbox2.Gtk.Box+BoxChild
            ...
            w22.Pixbuf = Stetic.IconLoader.LoadIcon(this, "gtk-clear", Gtk.IconSize.Menu, 16);
            w21.Add(w22);
            // Container child GtkHBox.Gtk.Container+ContainerChild
            Gtk.Label w24 = new Gtk.Label();
            w24.LabelProp = Mono.Unix.Catalog.GetString("Clear Removed Items");
            w24.UseUnderline = true;
            w21.Add(w24);
            w20.Add(w21);
            this.clear_removed_button.Add(w20);
            this.hbox2.Add(this.clear_removed_button);
            Gtk.Box.BoxChild w28 = ((Gtk.Box.BoxChild)(this.hbox2[this.clear_removed_button]));
            w28.Position = 2;
            w28.Expand = false;
            w28.Fill = false;
